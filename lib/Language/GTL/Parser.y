...
formulas_or_inits_or_vars  : bool("contract") expr ";" formulas_or_inits_or_vars { \decl -> let ndecl = $4 decl
...
formulas_or_inits : bool("contract") expr ";" formulas_or_inits { \decl -> let ndecl = $4 decl
